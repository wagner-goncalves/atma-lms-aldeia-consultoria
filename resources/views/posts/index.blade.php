                    ...
                    <script>
                        $(document).ready(function() {
                            $("#empresa_id").change(function () {
                                empresa_id = $(this).val();
                                window.location.href = '{{ route('posts.show', ['post' => $curso->id]) }}?empresa_id=' + empresa_id;
                              });
                        });
                    </script>
                    <div class="col-12 col-md-8 col-sm-12">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm reply-button"
                                                data-post_id="{{ $post->id }}"><i class="fa fa-reply"></i>&nbsp;
                                                Responder</button>
                                            @role('Admin|Gestor')
                        ...
                        <div class="col-12 col-md-4 col-sm-12 mb-3">
                            <div class="card" style="width: 100%">
                                <div class="list-group">
                                    ...
                                    {!! Form::open(['route' => ['posts.store', ['curso_id' => $curso->id]], 'method' => 'POST', 'enctype' =>
                                    'multipart/form-data', 'id' => 'edit-form']) !!}
                                    <div class="card-body">
                                        <div class="form-group">
                                            {!! Form::textarea('post', null, ['placeholder' => 'Seu texto', 'class' => 'form-control', 'id'
                                            => 'descricao']) !!}
                                        </div>
                                        <div>
                                            <button type="submit"
